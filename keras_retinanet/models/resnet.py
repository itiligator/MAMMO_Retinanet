...
def ResNet50RetinaNet(inputs, num_classes, weights='imagenet', *args, **kwargs):
    ...
    # load pretrained GURO weights? 
    elif weights == 'GURO':
        weights_path = now_path + '/keras_retinanet/pretrainedmodel/GURO.h5'

    # load pretrained INBreast weights? 
    elif weights == 'INBreast':
        weights_path = now_path + '/keras_retinanet/pretrainedmodel/INBreast.h5'
    else:
