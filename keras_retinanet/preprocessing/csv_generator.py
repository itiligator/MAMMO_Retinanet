    ...
    def __init__(
        ...
        **kwargs
        ...
        if self.base_dir is None:
            if csv_datatype.lower() == 'inbreast':
                self.base_dir='/media/hwejin/SSD_1/DATA/DATAForPaper/DATA/INBREAST/AllInOne'
            elif csv_datatype.lower() == 'guro':
                self.base_dir='/media/hwejin/SSD_1/DATA/DATAForPaper/DATA/GURO/AllInOne'
            else:
                self.base_dir='/media/hwejin/SSD_1/DATA/DATAForPaper_v2/Img'
